...
public class MainActivity extends Activity implements OnClickListener {
	...
	void initial(){
		for(int i = 0;i < 10;i++){
        	PreActivity.key_title[i] = "title" +Integer.toString(i);/*タイトル*/
        	PreActivity.key_recovery[i] = "recovery" + Integer.toString(i);/*回復*/
        	PreActivity.key_notice[i] = "notice" + Integer.toString(i);/*通知/*/
        }
	}
	/*ボタンやテキストビューの関連付け*/
	@Override
